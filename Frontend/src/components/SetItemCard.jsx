    ...
    // Make API request using Axios
        ...
        try {
            ...
            if (inputValue.trim() !== '') {
                ...
                axios.patch(`http://localhost:8080/api/products/update/${item._id}`, { stock: item.stock + Number(inputValue) });
                setAlertMessage(<div className="alert alert-success alert-dismissible fade show" role="alert">Stock changed successfully</div>);
